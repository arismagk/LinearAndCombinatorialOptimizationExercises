        ...
        while (True):
            ...
            for i in range(1, len(tableau)):
                for j in range (1, len(n_list)):
                    if (tableau[i, n_list[j]] > 0):
                        val = tableau[i, 1] / tableau[i, n_list]
                        if val < minimum:
                            minimum = val
                            r = i

                        pivot = tableau[r, n_list[j]]

                        print("Pivot Column:", n_list[j])
                        print("Pivot Row:", r)
            ...
            for i in range(0, len(tableau)):
                for j in range(1, len(n_list)):
                    if i != r:
                        mult = tableau[i, n_list] / tableau[r, n_list[j]]
                        tableau[i, 1:] = tableau[i, 1:] - mult * tableau[r, 1:]

                    # new basic variable
                    tableau[r, 0] = n_list[j] - 2
